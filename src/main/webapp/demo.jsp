...
<head>
    ...
    <style>
        ...
        .alipay_select {
            width: 120px;
            background: url(images/alipay.jpg) no-repeat 14px 0;
        }

        .qqpay_select {
            width: 130px;
            background: url(images/qqpay.jpg) no-repeat 14px 0;
        }
			/* http://codepay.fateqq.com/img/weixin.jpg */
        .wechat_select {
            width: 120px;
            background: url(images/weixin.jpg) no-repeat 16px 0;
...
<body>
<form name="form1" id="form1" method="get" action="pay/CodePay.action">
    <div>
